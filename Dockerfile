...
RUN keytool -importcert -alias zeuspext01 -keystore "/usr/lib/jvm/java-1.8.0/jre/lib/security/cacerts" -noprompt -storepass changeit -file "/usr/app/zeuzCert/zeuspext01.cer"
